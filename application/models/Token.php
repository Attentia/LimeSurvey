    ...
    abstract class Token extends Dynamic
    {
        ...
        public static function createTable($surveyId, array $extraFields  = array())
        {
            ...
            $fields = array(
                ...
                'sent' => "string(17) CONSTRAINT DF__lime_tokens_{$surveyId}_INVITATION_SENT DEFAULT 'N'",
                'remindersent' => "string(17) CONSTRAINT DF__lime_tokens_{$surveyId}_REMINDER_SENT DEFAULT 'N'",
                'remindercount' => "integer CONSTRAINT DF__lime_tokens_{$surveyId}_REMINDER_COUNT DEFAULT 0",
                'completed' => "string(17) CONSTRAINT DF__lime_tokens_{$surveyId}_COMPLETED DEFAULT 'N'",
                'usesleft' => "integer CONSTRAINT DF__lime_tokens_{$surveyId}_REMINDER_USESLEFT DEFAULT 1",
                'validfrom' => 'datetime',
                'validuntil' => 'datetime',
                'mpid' => 'integer'
            );
